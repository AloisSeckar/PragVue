<template>
  <div class="flex flex-col h-screen items-center justify-start bg-[#3c3c3c]">
    <a name="features"><h2 class="text-4xl text-[#ff6c43] font-bold">THE FEATURES</h2></a>
    ...
    <div class="flex mt-4 gap-2">
      <a href="https://www.konference.cz/" class="rounded-lg hover:border-2 hover:border-[#ff6c43]">
        <img src="/nav-features-join.jpg" class="rounded-lg w-[300px] h-[150px]">
      </a>
      <a href="#summary" class="rounded-lg hover:border-2 hover:border-[#ff6c43]">
        <img src="/nav-features-more.jpg" class="rounded-lg w-[300px] h-[150px]">
      </a>
    </div>
  </div>
</template>
