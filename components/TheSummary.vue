<template>
  <div class="flex flex-col gap-2 items-center justify-start bg-[#dddddd] text-black">
    ...
    <a href="https://www.konference.cz/" class="rounded-lg hover:border-2 hover:border-[#ff6c43]">
      <img src="/nav-summary-2.jpg" class="rounded-lg w-[300px] h-[150px]">
    </a>
    <a href="https://www.konference.cz/" class="rounded-lg hover:border-2 hover:border-[#ff6c43]">
      <img src="/nav-summary-3.jpg" class="rounded-lg w-[300px] h-[150px]">
    </a>
    <a href="https://www.konference.cz/" class="rounded-lg hover:border-2 hover:border-[#ff6c43]">
      <img src="/nav-summary-4.jpg" class="rounded-lg w-auto h-[300px]">
    </a>
